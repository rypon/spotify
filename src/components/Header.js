...
function Header({ artist, secondArtist, LanderStatus, startArtist, guess }) {
  const invalidImage =
    ...
    <div>
      ...
      <div class="grid sm:grid-cols-3 justify-center">
        <div class="justify-self-center">
          ...
          >
            <p className="card-p-title">
              {startArtist?.name === undefined ? "" : startArtist?.name}
            </p>
        ...
        <div class="justify-self-center">
          ...
          >
            <p className="card-p-title">
              {secondArtist?.name === undefined ? "" : secondArtist?.name}
            </p>
            <p>
